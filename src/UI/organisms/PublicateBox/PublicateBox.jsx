...
function PublicateBox({customClassBox,pathImg,pathVideo,seguir,time,nickname}) {
  return (
    <div className={`${styles.PublicateBox} ${customClassBox}`}>
      <PublicateNicknameBar customClass={styles.PublicateBox__Nickname} time={time} nickname={nickname} seguir={seguir}/>
