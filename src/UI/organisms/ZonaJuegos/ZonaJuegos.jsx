    ...
    <div className={styles.ZonaJuegos__Centro}>
      <div className={styles.Centro__TituloSeccion}>
        ...
        <div className={styles.Centro__FilaJuegos}>
          <TarjetaJuego CardsCustomClass={styles.FilaJuegos__Card1} CardsContainerCustomClass={styles.FilaJuegos__Card1_Container} text="Ludo clasico"/>
