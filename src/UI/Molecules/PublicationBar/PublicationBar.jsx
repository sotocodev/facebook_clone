  ...
  return (
    <div className={`${styles.PublicationBar} ${customClass}`}>
        <div className={styles.PublicationBar__Publicate}>
            <Img customClass={styles.PublicationBar__PublicateImgIcon} path="../../Public/assets/Icons/Gokupelon.jpeg"/>
        ...
        <ButtonTo text="Video en Vivo" path="../../../Public/assets/Icons/Camare.png"/>
        <ButtonTo text="Foto" path="../../../Public/assets/Icons/photo.png"/>
        <ButtonTo text="Sentimientos/actividad" path="../../../Public/assets/Icons/Smile.png"/>
        </div>
