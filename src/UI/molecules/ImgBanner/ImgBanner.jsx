  ...
  return (
    <div className={`${styles.ImgBanner} ${customClass}`}>
      <div className={styles.ImgBanner__SecctionProfile}>
        ...
        <PublicateButton
          customClassDiv={styles.ImgBanner__ChangeDiv}
          customClass={styles.ImgBanner__ChangeImg}
          path="/photo.png"
        />
        <div className={styles.ImgBanner__SecctionName}>
          <Nickname
            customClassSpan={styles.ImgBanner__Span}
            customClassParagraph={styles.ImgBanner__Nickname}
            textSecondari="17 amigos"
            textName="Goku Pelon"
          />
        </div>
      </div>
